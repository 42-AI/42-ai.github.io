...
<hr/>
    ...
    <div class="row" style="align-items: center; display:flex; margin-top: 15px">
        <div class="col-1 col-xs-12"><img src="{{current_team.safety.person.photo}}" width=48px/></div>
        <div class="col-5 col-xs-12">{{current_team.safety.person.name}}</div>
        <div class="col-5 col-xs-12"><span>{{current_team.safety.title[lang]}}</span></div>
        <!-- <div class="col-2">
            <span style="display: flex; justify-content: space-evenly">
                <a href="{{current_team.safety.person.github}}"><i class="fab fa-github"></i></a>
                <a href="{{current_team.safety.person.linkedin}}"><i class="fab fa-linkedin"></i></a>
                <a href="{{current_team.safety.person.twitter}}"><i class="fab fa-twitter"></i></a>
            </span>
            </div> -->
    </div>
